...
\noindent \textbf{Lemma 3.4} For any integer $n \geq 2$, we have \\ $ (\forall a_n, \ldots, a_0, b_n, \ldots, b_0, c \in \{T, F\} ) \;  CLANCO(a_n, \ldots, a_0, b_n, \ldots, b_0, c) \iff CRACO(a_n, \ldots, a_0, b_n, \ldots, b_0, c) $
\begin{proof}
	\begin{align*}
	\end{align*}
\end{proof}

\noindent \textbf{Lemma 3.5} For any integer $n \geq 2$, we have \\ $ (\forall a_n, \ldots, a_0, b_n, \ldots, b_0, c \in \{T, F\} ) \;  CLANS_0(a_n, \ldots, a_0, b_n, \ldots, b_0, c) \iff CRAS(a_n, \ldots, a_0, b_n, \ldots, b_0, c) $
\begin{proof}
	\begin{align*}
	\end{align*}
\end{proof}

\noindent \textbf{Lemma 3.6} For any integer $n \geq 2$, we have \\ $ (\forall a_n, \ldots, a_0, b_n, \ldots, b_0, c \in \{T, F\} ) \;  CLANS_1(a_n, \ldots, a_0, b_n, \ldots, b_0, c) \iff CRAS(a_n, \ldots, a_0, b_n, \ldots, b_0, c) $
\begin{proof}
	\begin{align*}
	\end{align*}
\end{proof}
